 ...
 */
@Entity
public class DrawInvsDetailInfo {
    ...
    @Generated(hash = 371509134)
    public DrawInvsDetailInfo(Long id, String uid, String no, String externalNo, String externalAreaId, String externalAreaName, String externalLineId, String externalLineName, String cages, double totalPrice, int bagCount, int totalCount, String carId, String carNo, String carNum, boolean carOnline, String deliveryId, String deliveryName, String driverId, String driverName, List<HOrderModel> orders, int status, String bornDate, String sendDate, int goodsCount, String sendNo, String lineId, String lineName, String areaId, String areaName, int customerCount, int abnormalCount, String lastUpdateTime, String beforeUpdateTime,
            int packingType) {
        this.id = id;
        this.uid = uid;
        this.no = no;
    ...
    public DrawInvsDetailInfo(String uid, String no, String externalNo, String externalAreaId, String externalAreaName, String externalLineId, String externalLineName, String cages, double totalPrice, int bagCount, int totalCount, String carId, String carNo, String carNum, boolean carOnline, String deliveryId, String deliveryName, String driverId, String driverName, List<HOrderModel> orders, int status, String bornDate, String sendDate, int goodsCount, String sendNo, String lineId, String lineName, String areaId, String areaName, int customerCount, int abnormalCount, String lastUpdateTime, int packingType,String beforeUpdateTime) {
        this.uid = uid;
        this.no = no;
        this.externalNo = externalNo;
        this.externalAreaId = externalAreaId;
    ...
    @Generated(hash = 1181653557)
    public DrawInvsDetailInfo() {
    }
    public Long getId() {
        return this.id;
    }
